...
v-card(
  ...
  v-card-text
    ...
    ul
      li
        ...
        strong Company
        |  (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Vitaliy Ostapchuk portfolio.
      li
        strong Country
        |  refers to: Baden-Württemberg, Germany
      li
        strong Service
        |  refers to this Website.
      li
        strong Terms of Service
        |  (also referred as "Terms" or "Terms and Conditions") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement as been created with the help of Terms and Conditions Generator.
      li
      ...
      li
        strong Website
        |  refers to Vitaliy Ostapchuk portfolio, accessible from
        a  https://vitaliy-ostapchuk.netlify.com/
      li
        strong You
  ...
  v-card-text
    strong "AS IS" and "AS AVAILABLE" Disclaimer
  ...
  v-card-text
    strong For European Union (EU) Users
  ...
  v-card-text
    strong United States Legal Compliance
    p You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a “terrorist supporting” country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
  v-card-text(
    class="text-uppercase"
  )
    strong Severability and Waiver
  v-card-text
    strong Severability
